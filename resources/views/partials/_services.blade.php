			...
			<section class="service text-center" id="service">
				<div class="container">
					<div class="row">
						<h2>Nos services</h2>
						<div class="offrir"><h4>Notre mission est de fournir aux opérateurs de téléphonie mobile un service de qualité qui intervient dans le domaine des télécommunications,  précisément dans le déploiement, la maintenance, l'ingénierie, l'optimisation des réseaux mobiles et le développement d'applications web et mobile</h4></div>
